...
#ifndef ACCommon_ACDefines_h
#define ACCommon_ACDefines_h
...
#define COLORHEXA(hex,a) \
[UIColor colorWithRed:((float)(((hex) & 0xFF0000) >> 16)) / 256.0 \
                green:((float)(((hex) & 0xFF00) >> 8)) / 256.0    \
                 blue:((float)((hex) & 0xFF)) / 256.0             \
                alpha:(a)]

#define COLORRGBA(r,g,b,a) \
[UIColor colorWithRed:(r) / 256.0f                              \
                green:(g) / 256.0f                              \
                 blue:(b) / 256.0f                              \
                alpha:(a)]
